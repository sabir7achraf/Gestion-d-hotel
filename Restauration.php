        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Restauration</h1>
                    <p class="mb-4">c'est un table qui represente les factures qui sont realiser par le departement Restauration </p>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    $requete=$conn->prepare("SELECT * FROM facture where departement ='Restauration'");
                                    $requete->execute();
                        ...
                        ?>
                                        <tr>
                                            ...
                                            <td><a href="Consultfacture.php?id=<?php echo $row['id']?>" class="btn btn-danger">consulter</a>
