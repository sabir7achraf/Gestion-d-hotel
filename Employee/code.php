...
if(isset($_POST['login_btn']))
{
    ...
    $query = "SELECT * FROM employe WHERE email='$email_login' AND password='$password_login' ";
    $query_run = mysqli_query($connection, $query);
...
if(isset($_POST['addbtn']))
{
    ...
    $message = $_POST['message']; 
            ...
            $query = "INSERT INTO demande(type , statut , message , employe_id) VALUES ('$type' , '$statut' , '$message' , '11')" ; 
            $query_run1 = mysqli_query($connection, $query);
            if(mysqli_num_rows($query2_run) > 0){
                $row = mysqli_fetch_assoc($query2_run) ; 
            } 
    ...
    if(isset($_POST['demande_delete_btn']))
{
    $id = $_POST['delete_delete_btn'];

    $query = "DELETE FROM demande WHERE id=14 ";
    $query_run = mysqli_query($connection, $query);
    ...
    if($query_run)
    {
        $_SESSION['status'] = "Your Data is Deleted";
        $_SESSION['status_code'] = "success";
        header('Location: empl_demande.php'); 
    }
    else
    {
        $_SESSION['status'] = "Your Data is NOT DELETED";       
