...
<body id="page-top">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleInputPassword1" name="montant">
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">description</label>
    <textarea class="form-control" id="exampleInputPassword1" name="desscription"></textarea>
  </div>
...
<?php                              
 ...
 if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO rapport (title, departement, montant,desscription) VALUES (?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $resulta = $stmt->execute([$title, $departemen, $montant, $description]);
    if ($resulta) {
...
<div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Rapport table</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    $requete=$conn->prepare("SELECT * FROM rapport");
                                    $requete->execute();
                        ...
                        ?>
                                        <tr>
                                            ...
                                            <td><a href="rapportconsulte.php?id=<?php echo $row['id']?>" class="btn btn-danger">consulter</a></td>
                                        </tr>
                                        <?php
}
?>
