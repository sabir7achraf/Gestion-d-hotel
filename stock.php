...
$requete=$conn->prepare("SELECT * FROM facture WHERE departement = 'stock'");
$requete->execute();
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">c'est un table qui afficher les factures de departement stockes </p>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Factures de Stock </h6>
                        </div>
                        <div class="card-body">
                        ...
                        ?>
                                        <tr>
                                            ...
                                            <td><button type="button" class="btn btn-danger" data-bs-dismiss="modal" >consulter</button></td>
                                            <td><?php if($row['statue']=='0'){
                                                
                                                ?>
                                                <a href="payementstock.php?id=<?php echo $row['id']?>" class="btn btn-success">payer</a>
                                             <?php
                                             }
                                             else {
